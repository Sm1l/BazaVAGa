...
})({"kEDvC":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "8e27d9d84b4eb12f";
...
},{"./burger.js":"5KBwH","./modal.js":"aHHgN","./scroll.js":"55W1t"}],"5KBwH":[function(require,module,exports) {
...
modal.addEventListener("click", function(evt) {
    if (!evt.target.closest(".modal__content")) closeOnClick();
});
window.addEventListener("keydown", function(evt) {
    if (evt.key === "Escape") {
        evt.preventDefault();
        if (modal.classList.contains("modal-show")) closeOnClick();
    }
});
function closeOnClick(evt) {
...
},{}]},["kEDvC","ebWYT"], "ebWYT", "parcelRequire29de")

//# sourceMappingURL=index.4b4eb12f.js.map
